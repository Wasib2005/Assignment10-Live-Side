    ...
    <div className="">
      <div className="relative">
        ...
        <div className="absolute top-6 md:top-20 lg:top-32 left-[84px]  z-[2] grid gap-3 lg:gap-7">
          ...
          <div>
            <Link className="relative inline-flex items-center justify-start py-2 md:py-3 pl-2 md:pl-4 pr-12 overflow-hidden text-base md:text-xl font-semibold text-blue-600 transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-50 group">
